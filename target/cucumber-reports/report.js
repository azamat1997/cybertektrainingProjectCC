...
formatter.step({
  "name": "User enter \"json\" in subject",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User enter \"3123127777\" in mobile number",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User enter \"Johns inc\" compamy name",
  "keyword": "And "
});
formatter.match({
...
formatter.uri("src/test/resources/features/studentTeacher.feature");
formatter.feature({
...
formatter.scenarioOutline({
  "name": "Add new student functionality",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
