...
Feature:
  ...
  Scenario Outline: Verify Create Teacher Functionality
    ...
    Examples:
      ...
      | Dwight     | Schrute   | dwightschrute@dundermifflin.com | 01/01/2000   | 6789     | Business | 847-555-5678  | Male   | Sales      | 08/15/1980 | 100000 | 14    | Paper   | Scranton, PA      |
  ...
  Scenario Outline: verify update student functionality
    ...
    And User clicks "<Lastname>"
    And User clicks "<Email>"
    And User clicks "<Joining Date>"
    And User clicks "<Password>"
    And User clicks "<Subject>"
    And User clicks "<Mobile number>"
    And User clicks "<Gender>"
    And User clicks "<Admission No>"
    And User clicks "<Gender>"
    And User clicks "<Admission No>"
    And User clicks "<Birth Date>"
    And User clicks "<Major>"
    And User clicks "<Batch>"
    And User clicks "<Section>"
    And User clicks "<Premanent Address>"
    And User clicks "<Company Name>"
    And User clicks "<Title>"
    And User clicks "<Start Date>"
    And User clicks "<City>"
    And User clicks "<Street>"
    And User clicks "<ZipCode>"
    And User clicks "<State>"
